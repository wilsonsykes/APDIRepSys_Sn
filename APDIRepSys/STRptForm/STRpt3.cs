...
{
    public partial class STRpt3 : Form
    {
        ...
        private void STRpt3_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.sThruReport3TableAdapter1.Connection.ConnectionString = global::APDIRepSys.DatabaseConnectionHelper.GetOdbcConnectionString();
                this.sThruReport3TableAdapter1.Fill(this.dataSet7.SThruReport3);
                dataGridView1.DataSource = this.dataSet7.SThruReport3; // ✅ Start with full dataset


                //Apply Number Format with Commas for Readability
                dataGridView1.Columns["current_invty_amt3mos"].DefaultCellStyle.Format = "N2";
                dataGridView1.Columns["current_invty_amt3mos"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                ...
                dataGridView1.Columns["scheduled6mosDataGridViewTextBoxColumn"].DefaultCellStyle.Format = "MM/dd/yyyy";
                dataGridView1.Columns["scheduled6mosDataGridViewTextBoxColumn"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                ...
                System.Data.DataView dv = new System.Data.DataView(this.dataSet7.SThruReport3);
                ...
                try
                {
                    ...
                    using (NpgsqlTransaction transaction = conn.BeginTransaction()) // ✅ Ensure atomicity
                    {
                        ...
                        foreach (DataGridViewRow row in dataGridView1.Rows)
                        {
                            ...
                            // ✅ Determine if report_period should be "3 months"
                            string reportPeriod = row.Cells["scheduled6mosDataGridViewTextBoxColumn"].Value == DBNull.Value ? null : "3 months";
                            ...
                            string insertQuery = "INSERT INTO system_sellthru_summary " +
                                ...
                                "category_code, product_status, current_price, store_group, mos3_item_sold, mos3_closing_invty, " +
                                "mos3_sale_rate, mos3_revenue, mos3_invty_amount, order_qty, next_sched_date, report_period, image) " +
                            ...
                            using (NpgsqlCommand cmd = new NpgsqlCommand(insertQuery, conn))
                            {
                                ...
                                cmd.Parameters.AddWithValue("@current_invty", row.Cells["current_invty_3mos"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToInt32(row.Cells["current_invty_3mos"].Value));
                                cmd.Parameters.AddWithValue("@current_invty_amount", row.Cells["current_invty_amt3mos"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["current_invty_amt3mos"].Value));
                                ...
                                cmd.Parameters.AddWithValue("@product_status", row.Cells["product_status"].Value == DBNull.Value ? (object)DBNull.Value : row.Cells["product_status"].Value.ToString());
                                ...
                                cmd.Parameters.AddWithValue("@mos3_item_sold", row.Cells["mositemsoldDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToInt32(row.Cells["mositemsoldDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@mos3_closing_invty", row.Cells["closinvtyDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToInt32(row.Cells["closinvtyDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@mos3_sale_rate", row.Cells["mossalerateDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["mossalerateDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@mos3_revenue", row.Cells["mosrevenueDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["mosrevenueDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@mos3_invty_amount", row.Cells["mosinvtyamountDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["mosinvtyamountDataGridViewTextBoxColumn"].Value));
                                ...
                                cmd.Parameters.AddWithValue("@next_sched_date", row.Cells["scheduled6mosDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDateTime(row.Cells["scheduled6mosDataGridViewTextBoxColumn"].Value).Date);
        ...
        private void ResetFilters()
        {
            ...
            dataGridView1.DataSource = this.dataSet7.SThruReport3;
