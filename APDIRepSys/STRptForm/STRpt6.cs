...
{
    public partial class STRpt6 : Form
    {
        ...
        private void STRpt6_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dataGridView1.Columns["currentinvtyamt6mosDataGridViewTextBoxColumn"].DefaultCellStyle.Format = "N2";
                dataGridView1.Columns["currentinvtyamt6mosDataGridViewTextBoxColumn"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                dataGridView1.Columns["unitpriceDataGridViewTextBoxColumn"].DefaultCellStyle.Format = "N2";
                dataGridView1.Columns["unitpriceDataGridViewTextBoxColumn"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                dataGridView1.Columns["mosrevenueDataGridViewTextBoxColumn2"].DefaultCellStyle.Format = "N2";
                dataGridView1.Columns["mosrevenueDataGridViewTextBoxColumn2"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                dataGridView1.Columns["mosinvtyamountDataGridViewTextBoxColumn2"].DefaultCellStyle.Format = "N2";
                dataGridView1.Columns["mosinvtyamountDataGridViewTextBoxColumn2"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                dataGridView1.Columns["scheduled9mosDataGridViewTextBoxColumn"].DefaultCellStyle.Format = "MM/dd/yyyy";
                dataGridView1.Columns["scheduled9mosDataGridViewTextBoxColumn"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                ...
                dataGridView1.Columns["mos6_sale_rate"].DefaultCellStyle.Format = "P0";
                dataGridView1.Columns["mos6_sale_rate"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;


                System.Data.DataView dv = new System.Data.DataView(this.dataSet8.SThruReport6);
                ...
                try
                {
                    ...
                    using (NpgsqlTransaction transaction = conn.BeginTransaction()) // ✅ Ensure atomicity
                    {
                        ...
                        foreach (DataGridViewRow row in dataGridView1.Rows)
                        {
                            ...
                            // ✅ Determine if report_period should be "9 months"
                            ...
                            // ✅ Fetch image path from products_list where name = productName
                            ...
                            string insertQuery = "INSERT INTO system_sellthru_summary " +
                                ...
                                "mos3_sale_rate, mos6_item_sold, mos6_closing_invty, mos6_sale_rate, mos6_revenue, mos6_invty_amount, order_qty, next_sched_date, image, report_period) " +
                            ...
                            using (NpgsqlCommand cmd = new NpgsqlCommand(insertQuery, conn))
                            {
                                ...
                                cmd.Parameters.AddWithValue("@current_invty", row.Cells["currentinvty6mosDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToInt32(row.Cells["currentinvty6mosDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@current_invty_amount", row.Cells["currentinvtyamt6mosDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["currentinvtyamt6mosDataGridViewTextBoxColumn"].Value));
                                ...
                                cmd.Parameters.AddWithValue("@current_price", row.Cells["unitpriceDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["unitpriceDataGridViewTextBoxColumn"].Value));
                                ...
                                cmd.Parameters.AddWithValue("@mos6_closing_invty", row.Cells["closeinvtyDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToInt32(row.Cells["closeinvtyDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@mos6_sale_rate", row.Cells["mos6_sale_rate"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["mos6_sale_rate"].Value));
                                cmd.Parameters.AddWithValue("@mos6_revenue", row.Cells["mosrevenueDataGridViewTextBoxColumn2"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["mosrevenueDataGridViewTextBoxColumn2"].Value));
                                cmd.Parameters.AddWithValue("@mos6_invty_amount", row.Cells["mosinvtyamountDataGridViewTextBoxColumn2"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["mosinvtyamountDataGridViewTextBoxColumn2"].Value));
                                ...
                                cmd.Parameters.AddWithValue("@next_sched_date", row.Cells["scheduled9mosDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDateTime(row.Cells["scheduled9mosDataGridViewTextBoxColumn"].Value).Date);
                                cmd.Parameters.AddWithValue("@image", imagePath ?? (object)DBNull.Value); // ✅ Assign fetched image path
        ...
        private void ResetFilters()
        {
            ...
            dataGridView1.DataSource = this.dataSet8.SThruReport6;
