...
{
    public partial class STRpt2 : Form
    {
        ...
        private void STRpt2_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.sThruReport2TableAdapter1.Connection.ConnectionString = global::APDIRepSys.DatabaseConnectionHelper.GetOdbcConnectionString();
                this.sThruReport2TableAdapter1.Fill(this.DataSet2.SThruReport2);
                dataGridView1.DataSource = this.DataSet2.SThruReport2; // ✅ Start with full dataset


                //Apply Number Format with Commas for Readability
                dataGridView1.Columns["currentinvtyamt2mosDataGridViewTextBoxColumn"].DefaultCellStyle.Format = "N2";
                dataGridView1.Columns["currentinvtyamt2mosDataGridViewTextBoxColumn"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                ...
                System.Data.DataView dv = new System.Data.DataView(this.DataSet2.SThruReport2);
                    ...
                    using (NpgsqlTransaction transaction = conn.BeginTransaction()) // ✅ Ensure atomicity
                    {
                        ...
                        foreach (DataGridViewRow row in dataGridView1.Rows)
                        {
                            ...
                            string insertQuery = "INSERT INTO system_sellthru_summary " +
                                ...
                                "category_code, product_status, current_price, store_group, mos2_item_sold, mos2_closing_invty, " +
                                "mos2_sale_rate, mos2_revenue, mos2_invty_amount, order_qty, next_sched_date, report_period, image) " +
                            ...
                            using (NpgsqlCommand cmd = new NpgsqlCommand(insertQuery, conn))
                            {
                                ...
                                cmd.Parameters.AddWithValue("@current_invty", row.Cells["currentinvty2mosDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToInt32(row.Cells["currentinvty2mosDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@current_invty_amount", row.Cells["currentinvtyamt2mosDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["currentinvtyamt2mosDataGridViewTextBoxColumn"].Value));
                                ...
                                cmd.Parameters.AddWithValue("@mos2_item_sold", row.Cells["mositemsoldDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToInt32(row.Cells["mositemsoldDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@mos2_closing_invty", row.Cells["closinginventoryDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToInt32(row.Cells["closinginventoryDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@mos2_sale_rate", row.Cells["mossalerateDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["mossalerateDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@mos2_revenue", row.Cells["mosrevenueDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["mosrevenueDataGridViewTextBoxColumn"].Value));
                                cmd.Parameters.AddWithValue("@mos2_invty_amount", row.Cells["mosinvtyamountDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDecimal(row.Cells["mosinvtyamountDataGridViewTextBoxColumn"].Value));
                                ...
                                cmd.Parameters.AddWithValue("@next_sched_date", row.Cells["scheduled3mosDataGridViewTextBoxColumn"].Value == DBNull.Value ? (object)DBNull.Value : Convert.ToDateTime(row.Cells["scheduled3mosDataGridViewTextBoxColumn"].Value).Date);
        ...
        private void ResetFilters()
        {
            ...
            dataGridView1.DataSource = this.DataSet2.SThruReport2;
